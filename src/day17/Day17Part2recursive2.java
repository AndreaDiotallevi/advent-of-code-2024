...
public class Day17Part2recursive2 {
    static class Computer {
        ...
        public String runInstruction(Integer opcode, Integer literalOperand) {
            ...
            switch (opcode) {
                ...
                case 5:
                    ...
                    output1 = String.valueOf(result5A);
    ...
    public static String processFile() {
        ...
        Computer computer = new Computer(35184372088832L, 0L, 0L, program);
        ...
        while (instructionPointer < program.size() - 1) {
            String mapKey = computer.registerA + "-" + computer.registerB + "-" + computer.registerC + "-"
                    + instructionPointer;

            if (myMap.containsKey(mapKey)) {
                if (computer.output.isEmpty()) {
                    result = myMap.get(mapKey);
                } else {
                    result = computer.output + "," + myMap.get(mapKey);
                }
                break;
            } else {
                myMap.put(mapKey, mapKey);
            }
            ...
            System.out.println("registerC=" + computer.registerC);

                ...
                while (i < poolSize - 1) {
                    for (int j=i+1; j<poolSize; j++) {
                        ...
                        while(!finished) {
                            ...
                            candidate.add(0, (first.get(0)<second.get(0)) ? (first.get(0)-xDiff*multiplier) : (first.get(0)+xDiff*multiplier));
                            candidate.add(1, (first.get(1)<second.get(1)) ? (first.get(1)-yDiff*multiplier) : (first.get(1)+yDiff*multiplier));
                            ...
                            if (
                                ...
                                if (matrix.get(candidate.get(0)).get(candidate.get(1)) != key) {
                                    occurrencesMap.add(String.valueOf(candidate.get(0))+ "-" +String.valueOf(candidate.get(1)));
                                }
                                multiplier++;
                            } else {
                                finished = true;
                        ...
                        while(!finished) {
                            List<Integer> candidate = new ArrayList<>();
                            candidate.add(0, (first.get(0)<second.get(0)) ? (second.get(0)+xDiff*multiplier) : (second.get(0)-xDiff*multiplier));
                            candidate.add(1, (first.get(1)<second.get(1)) ? (second.get(1)+yDiff*multiplier) : (second.get(1)-yDiff*multiplier));
